...
describe("POST /tareas", () => {
  it("CASO FELIZ: debe crear una tarea cuando se envía título y descripción", async () => {
    const nuevaTarea = {
  ...
  it("CASO DE ERROR: debe responder con 400 si falta algún campo obligatorio", async () => {
    const tareaInvalida = {
